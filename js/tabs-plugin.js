...
class Tabs {
  ...
  _getRefs(root) {
    ...
    refs.panes = document.querySelector(`${root} [data-delicious]`);
...
const tabs1 = new Tabs({
  rootSelector: '#delicious-tabs',
  activeControlClass: 'delicious__item-active',
  activePaneClass: 'delicious__active',
  activeTab: 2,
});